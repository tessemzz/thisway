...
function fadePhotosIn() {
    fadeImageIn1("#photo1", 83);
    setTimeout(function() {
        fadeImageIn2("#photo2", 47);
        setTimeout(function() {
            fadeImageIn2("#photo3", 25);
            setTimeout(function() {
                fadeImageIn2("#photo4", 44);
            }, 250);
        }, 250);
    }, 250);
}

function fadeImageIn1(photoId, top) {
    var topStr = top + 'px'
    $(function() {
        $(photoId).animate({
            opacity: '1'
...
function fadeImageIn2(photoId, top) {
    var topStr = top + '%'
    $(function() {
        $(photoId).animate({
            opacity: '1'
...
function initSeasons() {
    ...
    season1Left = (season1Width * -1) + "px";
    season1.style.left = season1Left;
    ...
    season2Left = ((season2Width + 1) * -1) + "px";
    season3Left = ((season3Width + 1) * -1) + "px";
    season4Left = (season4Width * -1) + "px";

    season2.style.left = season2Left;
    season3.style.left = season3Left;
    season4.style.left = season4Left;
}
